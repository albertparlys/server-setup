...
# ╚══════════════════════════════════════════════════════════╝
_MOD_DESC_php="PHP (cli + ekstensi umum)"
_MOD_DESC_postgres="PostgreSQL server + client"
_MOD_DESC_mariadb="MariaDB server + client"
...
eval "_chk=\${_seen_docker:-}"; [ -n "$_chk" ] && echo "  catatan: untuk docker tanpa sudo, logout/login dulu."
